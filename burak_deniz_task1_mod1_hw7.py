...
def doorCheck(LD, RD, CL, ML, LI, LO, RI, RO, GS):
    ...
    if GS.upper() not in {'P', 'N', 'D', '1', '2', '3', 'R'}:
        ...
        if LO == '1' and (RD == '0' and RI == '0' and RO == '0' and GS == 'P'):
            print("Left side open.")
            print(" ")
        elif RD == '1' and (LD == '1' or LO == '1' or LI == '0'):
            print("Both doors open")
            print(" ")
        elif RD == '1' and (LD == '0' or LO == '0' or LI == '0'):
            print("Right side open.")
            print(" ")
        elif LI == '1' and (RD == '0' and RI == '0' and RO == '0'):
            print("Left side open.")
            print(" ")
        elif LO == '1' and (RD == '0' and RI == '0' and RO == '0' and GS == 'P'):
            print("Left side open.")
            print(" ")
        elif RI == '1' and (LD == '0' or LO == '0' or LI == '0'):
            print("Right side open.")
            print(" ")
        else:
            print(" ")
